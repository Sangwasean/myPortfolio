...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    <article
     ...
     border border-solid border-dark bg-white shadow-2xl p-12 rounded-br-2xl"
    >
      <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] 
      rounded-[2.5rem] bg-dark rounded-br-2xl"/>
      <Link
      ...
      <div className="w-1/2  flex flex-col items-start justify-between pl-6 ">
        ...
        <div className="mt-2 flex items-center">
          ...
          <Link
           ...
           rounded-lg ml-4 p-2 px-6 text-lg"
          >
            Visit project
          </Link>
        </div>
...
const Project = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    border border-solid border-dark bg-white shadow-2xl p-6 relative"
    >
      <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] 
